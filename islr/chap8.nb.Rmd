...
# that sucks
Carav$Purchase <- as.numeric(Carav$Purchase)-1
...
library(gbm)
set.seed(1)
boost.caravan <- gbm(Purchase ~ ., data=train.set, n.trees=ntrees, shrinkage=shrinkage)
...
yhat.boost <- predict(boost.caravan, newdata=test.set)
```
